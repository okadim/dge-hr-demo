...
ROSTER = [
    ...
    {"key": "HCM_15",  "name": "Employee Career Assistant",               "badge": ORACLE, "activity": "6.2.1", "does": "Guides the new hire through the self-service HR portal on day one."},
    {"key": "HCM_79",  "name": "Succession Planning Advisor (Mentor Matcher)", "badge": ORACLE, "activity": "6.3.2", "does": "Matches the new hire with a suitable buddy / mentor from the team."},
    {"key": "HCM_149", "name": "Recommender (Onboarding)",                "badge": CUSTOM, "activity": "3.2.1", "does": "Recommends equipment entitlement based on the role and location."},
    {"key": "HCM_45",  "name": "Learning Creation Assistant",             "badge": ORACLE, "activity": "5.1.1", "does": "Determines the required training by role and location."},
    {"key": "HCM_123", "name": "Learning Assignments Assistant",          "badge": ORACLE, "activity": "5.1.1", "does": "Assembles and assigns the learning items to the new hire."},
    {"key": "HCM_46",  "name": "Learning Tutor",                          "badge": ORACLE, "activity": "5.2.1", "does": "Supports the new hire through e-learning modules and assessments."},
    {"key": "HCM_120", "name": "Compliance Dashboard Updates",            "badge": CUSTOM, "activity": "5.3.1", "does": "Monitors training completion against deadlines and updates the compliance dashboard."},
    {"key": "HCM_125", "name": "Manager Edge",                            "badge": ORACLE, "activity": "8.1.2", "does": "Prepares check-in agendas and talking points for the manager."},
    {"key": "HCM_85",  "name": "Team Sync Advisor",                       "badge": ORACLE, "activity": "8.1.2", "does": "Aligns check-in points with the team's context and cadence."},
    {"key": "HCM_119", "name": "Check-in Transcript Assistant",           "badge": ORACLE, "activity": "8.1.3", "does": "Captures and records check-in notes automatically."},
